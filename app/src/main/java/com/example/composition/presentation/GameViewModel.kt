...
class GameViewModel(
    ...
    private fun startTimer() {
        timer = object : CountDownTimer(
            ...
            override fun onTick(millisecondsUntilFinished: Long) {
                _formattedTime.value = formatTime(millisecondsUntilFinished)
            }
    ...
    private fun formatTime(millisecondsUntilFinished: Long) : String {
        val seconds = millisecondsUntilFinished / MILLIS_IN_SECONDS
        val minutes = seconds / SECONDS_IN_MINUTES
        val leftSeconds = seconds - minutes * SECONDS_IN_MINUTES
        return String.format("%02d:%02d", minutes.toInt(), leftSeconds.toInt())
    }
